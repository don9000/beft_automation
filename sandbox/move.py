...
destination_one = '/Users/donovanneethling/Documents/shutil_test/one/'
source_one = '/Users/donovanneethling/Documents/shutil_test/September2020/September2020/'
...
def archive_files(source, destination):
        ...
        if not os.path.isdir(destination + month_year()):
            os.mkdir(destination + month_year())
        for file_name in listfiles:
            archive_destination = destination + month_year() + '/'
            shutil.move(source + file_name, archive_destination + file_name)


archive_files(source_one, destination_one)
